...
import { Search, CalendarDays, ListTodo, Clock, LogIn, LogOut } from 'lucide-react';
...
export default function App() {
  const { user, loading, tasks, subjectsHistory, addTask, updateTaskStatus, deleteTask, updateSubjectsHistory } = useFirebaseSync();
      ...
      return (
          <div className="flex items-center justify-center h-[100dvh] w-full bg-zinc-900 text-zinc-100 px-4">
              <div className="max-w-sm w-full bg-zinc-800/50 border border-zinc-700 rounded-xl p-8 flex flex-col items-center text-center">
                  ...
                  <p className="text-zinc-400 text-sm mb-8">Войдите, чтобы ваши задачи, история предметов и таймер сохранялись на всех устройствах.</p>
                  
                  <button onClick={loginWithGoogle} className="w-full bg-white text-black font-medium py-3 px-4 rounded-lg flex items-center justify-center gap-3 hover:bg-zinc-200 transition-colors">
        ...
        <div className="p-4 pb-0 shrink-0">
          <div className="mb-4 xl:mb-6 shrink-0 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
                ...
                <button onClick={logout} className="p-2 text-zinc-500 hover:text-zinc-200 transition-colors rounded-lg bg-zinc-800/50 border border-zinc-700" title="Выйти">
